...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="../actions/login.php" method="post">
            ...
            <div class="mb-4">
                <input class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" type="submit" value="Log In">
            </div>
        </form>
        <p class="text-center text-gray-600 mt-6">
            If you are new here, <a class="text-blue-500 hover:text-blue-800" href="register">click here to register</a>.
        </p>
    </div>
